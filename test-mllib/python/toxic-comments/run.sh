...
FULLDATAPATH=user/root/data/$PROJECTNAME/input/
...
--test_data_file=data/$PROJECTNAME/input/sample_test.csv \
--train_data_file=data/$PROJECTNAME/input/sample_train.csv
